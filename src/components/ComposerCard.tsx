...
function ComposerCard(props: Props) {
    ...
    return (
        <div
            className={`block min-w-[12rem] h-full flex-grow rounded-lg text-left shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-cyan-500 mr-0 md:mr-2`}
        >
