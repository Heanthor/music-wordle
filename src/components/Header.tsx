    ...
    const renderDropdown = () => {
        ...
        return (
            <div className="relative ml-2">
                ...
                <ul
                    className={`${displayClass} absolute z-[1000] float-left m-0 min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg dark:bg-neutral-700 [&[data-te-dropdown-show]]:block`}
